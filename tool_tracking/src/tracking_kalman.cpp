...
ROS_ERROR("array callback");
	//Does this correspond to the motion update?
	//Do the motion update here.
	int i = 0;
...
//			seg_right = segmentation(rawImage_right);
			...
			//I think this is the other thing I want to override.
			trackingImgs = UKF.trackingTool(bodyVel, seg_left, seg_right, P_l, P_r); //with rendered tool and segmented img
//
